...
const About = () => {
    return (
        <section id="about" className="pt-5 pb-5 container-fluid" style={{background:'#131217'}}>
            ...
            <div class="card-body text-start" >
                <h4 class="mb-4"><span style={{borderLeft:"4px solid orange",paddingRight:"5px"}}></span>About Me</h4>
            ...
            <img class="rounded" src={img} alt="..." style={{height:'250px'}}/>
            </div>
            </div>
            </div>
            </div>
